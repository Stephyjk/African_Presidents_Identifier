...
def load_saved_artifacts():
    ...
    global __model
    if __model is None:
        with open('./artifacts/african_presidents_model.pkl', 'rb') as f:
...
if __name__ == '__main__':
    ...
    print(classify_image(None, './test_images/img_15.jpg'))
    print(classify_image(None, './test_images/img_3.jpg'))
    print(classify_image(None, './test_images/img_7.jpg'))
